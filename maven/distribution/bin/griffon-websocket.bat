...
@rem ##########################################################################
@rem
@rem  griffon-websocket startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute griffon-websocket
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_OPTS%  -classpath "%CLASSPATH%" io.github.aretche.griffonWebSocket.Launcher %CMD_LINE_ARGS%
